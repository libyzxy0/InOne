    ...
    <div className="flex items-center justify-center w-full bg-white">
      <div className="max-w-md w-full px-7 pt-16 pb-16">
        <div className="text-center">
          <h1 className="text-2xl font-mono font-semibold">Create Account | InOne</h1>
        </div>

        <div className="mt-16">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 grid grid-cols-1">
          ...
          <p className="text-sm py-4 text-center">
            ...
            <Link to="/terms" className="underline text-green-400">Terms of Service</Link> and{" "}
            <Link to="/privacy" className="underline text-green-400">Privacy Policy</Link>.
          </p>
          <p className="text-sm pt-4 text-center">Have an account? <Link to="/" className="text-green-400 hover:underline">{"Let's Login"}</Link></p>
